...
const en: TranslationDict = {
  ...
  "booking.subtitle":
    "Consultations available in-person in Jhansi or online via video call — clients welcome from anywhere in the world.",
  ...
  "booking.sidebar.desc":
    "Tell us in plain language what has happened, or what you are considering. No legal jargon needed — we reply within one working day.",
  ...
  "form.tierUHO": "UHO Card Holder — ₹1100",
  ...
  "form.thankYouDesc":
    "The chambers will respond within one working day at the email address you shared. For urgent matters (bail, custody), call",
  ...
  "practice.01.desc":
    "Bail, trial and appellate representation in criminal matters across sessions and superior courts.",
  "practice.02.title": "Corporate & Commercial",
  "practice.02.desc":
    "Advisory and contentious work for founders, family businesses and industry across Bundelkhand.",
  "practice.03.title": "Constitutional & Rights",
  "practice.03.desc":
    "Writ petitions, PILs and human-rights matters before High Courts and the Supreme Court.",
  "practice.04.title": "Advisory & Retainer",
  "practice.04.desc":
    "Standing counsel arrangements for institutions, trusts and non-profit organizations.",
  "practice.05.title": "Bail & Personal Liberty",
  "practice.05.desc":
    "Anticipatory & regular bail petitions, urgent habeas corpus, and protection of constitutional liberty.",
  "practice.06.title": "IP & Author Protection",
  "practice.06.desc":
    "Copyright advisory, publishing agreements, trademark registration, and author rights protection.",

  // ── UHO History ──
  "history.tag": "History",
  "history.title": "The United Human Organization.",
  "history.desc":
    "From a single legal practice in Jhansi to a global network of advocacy, law and environmental action — the story of UHO is the story of one conviction held long enough to become a movement.",
  "history.readFull": "Read the full history →",
  "history.ch01.title": "Foundation",
  "history.ch01.left":
    "The United Human Organization was founded in 2020 by Advocate Avinash Pathak with a single, uncompromising vision: to unite humanity through the instruments of law, peace, and sustainability.",
  "history.ch01.right":
    "Where most legal organizations are defined by their practice areas, UHO was conceived as something broader — a platform where jurisprudence meets civic responsibility, and where every legal act carries a social consequence. The founding tagline captures it simply:",
  "history.ch01.quote": "\u201cWe the Human of Earth.\u201d",
  "history.ch02.title": "Early Years",
  "history.ch02.left":
    "During his years at ALS, Avinash Pathak was simultaneously advising over 119 brands across sectors — an extraordinary volume of commercial legal work that forged a global legal perspective early.",
  "history.ch02.right":
    "Parallel to the legal work, thirteen years of continuous authorship produced nineteen books spanning ecology, jurisprudence, history and civic philosophy — not separate from the law, but the long form of the same argument.",
  "history.ch03.title": "UHO Law Club",
  "history.ch03.left":
    "The UHO Law Club was formally established — a legal network designed to make quality counsel accessible beyond traditional fee structures. Chambers opened in Jhansi, expanding to five offices worldwide by 2023.",
  "history.ch03.right":
    "A signature feature from the start: the UHO Card, granting members access to legal consultation at a community rate. Practice grew from District Court Jhansi to the Allahabad High Court and the Supreme Court of India.",
  "history.ch04.title": "Global Advocacy",
  "history.ch04.left":
    "UHO Mission 8 Billion asks every person to plant a tree on their birthday. The Great Aryan Dream and World Peace Treaty 2023 propose a framework for international civic reconciliation.",
  "history.ch04.right":
    "Green Bharat Great Bharat combines tree planting, river clean-up advocacy, and civic education — rooted in Bundelkhand but reaching across India's districts and beyond.",
  ...
  "initiatives.desc":
    "The United Human Organization is the civic arm of these chambers — running Green Bharat Great Bharat, the Saturday for Society movement, and the Pathak Temple Martial Arts Monastery. Advocacy, in its widest sense.",
...
const hi: TranslationDict = {
  ...
  "booking.subtitle":
    "परामर्श झाँसी में व्यक्तिगत रूप से या वीडियो कॉल द्वारा ऑनलाइन उपलब्ध है — दुनिया भर के क्लाइंट्स का स्वागत है।",
  ...
  "booking.sidebar.desc":
    "सरल भाषा में बताएं कि क्या हुआ है, या आप क्या सोच रहे हैं। कोई कानूनी शब्दावली ज़रूरी नहीं — हम एक कार्य दिवस में जवाब देते हैं।",
  ...
  "form.tierUHO": "UHO कार्ड धारक — ₹1100",
  ...
  "form.thankYouDesc":
    "कार्यालय आपके ईमेल पते पर एक कार्य दिवस में जवाब देगा। अत्यावश्यक मामलों (जमानत, हिरासत) के लिए कॉल करें",
  ...
  "practice.03.desc":
    "रिट याचिकाएँ, जनहित याचिकाएँ और मानवाधिकार मामले — उच्च न्यायालय और सर्वोच्च न्यायालय में।",
  "practice.04.title": "सलाहकार एवं रिटेनर",
  "practice.04.desc":
    "संस्थानों, ट्रस्टों और गैर-लाभकारी संगठनों के लिए स्थायी परामर्शदाता व्यवस्था।",
  "practice.05.title": "ज़मानत एवं व्यक्तिगत स्वतंत्रता",
  "practice.05.desc":
    "अग्रिम व नियमित ज़मानत याचिकाएँ, त्वरित बंदी प्रत्यक्षीकरण, और संवैधानिक स्वतंत्रता की रक्षा।",
  "practice.06.title": "कॉपीराइट एवं लेखक सुरक्षा",
  "practice.06.desc":
    "कॉपीराइट सलाह, प्रकाशन समझौते, ट्रेडमार्क पंजीकरण, और लेखक अधिकारों की सुरक्षा।",

  // ── UHO History ──
  "history.tag": "इतिहास",
  "history.title": "यूनाइटेड ह्यूमन ऑर्गनाइज़ेशन।",
  "history.desc":
    "झाँसी में एक कानूनी अभ्यास से वकालत, कानून और पर्यावरणीय कार्रवाई के वैश्विक नेटवर्क तक — UHO की कहानी एक विश्वास की कहानी है जो आंदोलन बन गई।",
  "history.readFull": "पूरा इतिहास पढ़ें →",
  "history.ch01.title": "स्थापना",
  "history.ch01.left":
    "यूनाइटेड ह्यूमन ऑर्गनाइज़ेशन की स्थापना 2020 में अधिवक्ता अविनाश पाठक ने एक अटल दृष्टि के साथ की: कानून, शांति और स्थिरता के माध्यम से मानवता को एकजुट करना।",
  "history.ch01.right":
    "जहाँ अधिकांश कानूनी संगठन अपने अभ्यास क्षेत्रों से परिभाषित होते हैं, UHO की कल्पना कुछ व्यापक के रूप में की गई — एक मंच जहाँ न्यायशास्त्र नागरिक ज़िम्मेदारी से मिलता है।",
  "history.ch01.quote": "\u201cहम पृथ्वी के मनुष्य।\u201d",
  "history.ch02.title": "प्रारंभिक वर्ष",
  "history.ch02.left":
    "ALS में अपने वर्षों के दौरान, अविनाश पाठक एक साथ 119 से अधिक ब्रांडों को सलाह दे रहे थे — वाणिज्यिक कानूनी कार्य की एक असाधारण मात्रा।",
  "history.ch02.right":
    "कानूनी कार्य के समानांतर, तेरह वर्षों के निरंतर लेखन ने पारिस्थितिकी, न्यायशास्त्र, इतिहास और नागरिक दर्शन में उन्नीस पुस्तकें प्रकाशित कीं।",
  "history.ch03.title": "UHO लॉ क्लब",
  "history.ch03.left":
    "UHO लॉ क्लब औपचारिक रूप से स्थापित किया गया — गुणवत्तापूर्ण परामर्श को पारंपरिक शुल्क संरचनाओं से परे सुलभ बनाने के लिए।",
  "history.ch03.right":
    "शुरू से एक विशिष्ट विशेषता: UHO कार्ड, सदस्यों को सामुदायिक दर पर कानूनी परामर्श तक पहुँच प्रदान करता है।",
  "history.ch04.title": "वैश्विक वकालत",
  "history.ch04.left":
    "UHO मिशन 8 बिलियन हर व्यक्ति से अपने जन्मदिन पर एक पेड़ लगाने का अनुरोध करता है। ग्रेट आर्यन ड्रीम और विश्व शांति संधि 2023 अंतरराष्ट्रीय नागरिक सुलह के लिए एक ढाँचा प्रस्तुत करते हैं।",
  "history.ch04.right":
    "ग्रीन भारत ग्रेट भारत वृक्षारोपण, नदी सफ़ाई वकालत और नागरिक शिक्षा को जोड़ता है — बुंदेलखंड में जड़ें, लेकिन भारत के ज़िलों में फैला हुआ।",
  ...
  "philosophy.quote":
    '"कानून कोई पेशा नहीं है जिसे मैंने कमाने के लिए चुना। यह एक उपकरण है — अच्छे से उपयोग करें तो सबसे छोटी आवाज़ की रक्षा करता है; बुरे से उपयोग करें तो सबसे बड़ी आवाज़ को चुप करता है। मेरा कार्यालय पहले के लिए मौजूद है।"',
  ...
  "initiatives.title":
    "एक अभ्यास जो पेड़ लगाता है, किताबें प्रकाशित करता है, और शनिवार आयोजित करता है।",
  "initiatives.desc":
    "यूनाइटेड ह्यूमन ऑर्गनाइज़ेशन इन कार्यालयों की नागरिक भुजा है — ग्रीन भारत ग्रेट भारत, सैटरडे फ़ॉर सोसाइटी आंदोलन और पाठक मंदिर मार्शल आर्ट्स मठ का संचालन।",
  ...
  "contact.desc":
    "UHO लॉ क्लब, बुंदेलखंड विश्वविद्यालय के पास, झाँसी। व्यक्तिगत और ऑनलाइन परामर्श उपलब्ध — दुनिया भर से क्लाइंट्स का स्वागत है।",
  ...
  "contact.writeInDesc":
    "अपने मामले को सरल भाषा में बताएं। कोई कानूनी शब्दावली ज़रूरी नहीं — हम एक कार्य दिवस में जवाब देते हैं।",
  ...
  // ── Footer ──
  "footer.desc":
    "अधिवक्ता अविनाश पाठक का कार्यालय। भारत के सर्वोच्च न्यायालय और उच्च न्यायालयों में परामर्श। संस्थापक, यूनाइटेड ह्यूमन ऑर्गनाइज़ेशन और UHO लॉ क्लब।",
