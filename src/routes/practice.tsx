  ...
  head: () => ({
    meta: [
      { title: "Practice Areas & Legal Counsel in Jhansi | UHO Law Club – Adv. Avinash Pathak" },
      {
        name: "description",
        content:
          "Comprehensive practice areas in Jhansi: criminal defence, bail matters, corporate & commercial advisory, constitutional writs before Allahabad High Court & Supreme Court.",
      },
      {
        property: "og:title",
        content: "Practice Areas & Legal Counsel in Jhansi | UHO Law Club – Adv. Avinash Pathak",
      },
      {
        property: "og:description",
        content:
          "Criminal defence, corporate contracts, constitutional rights, and legal retainer services in Jhansi.",
      },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://uholawclub.com/practice" },
    ],
    links: [{ rel: "canonical", href: "https://uholawclub.com/practice" }],
  }),
  component: Practice,
});
    ...
    <>
      <section className="mx-auto max-w-7xl px-6 pt-14 pb-16">
        ...
        <p className="mt-8 max-w-2xl text-lg leading-relaxed text-paper/75">
          The practice is deliberately broad. A single lawyer, held to a single standard of
          preparation, across matters where that standard matters most.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        ...
        <div className="mt-16 flex flex-wrap items-center justify-between gap-6 border-t border-border pt-8">
          <p className="max-w-xl text-sm text-muted-foreground">
            Not sure which category your matter falls under? Book a fifteen-minute preliminary call
            — the chambers will tell you honestly whether we're the right room.
          </p>
          <Link
            to="/appointment"
