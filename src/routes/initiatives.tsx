  ...
  head: () => ({
    meta: [
      { title: "Civic Initiatives | UHO Law Club & United Human Organization" },
      {
        name: "description",
        content:
          "Civic and environmental initiatives of Advocate Avinash Pathak and UHO Law Club (uholawclub) — Green Bharat Great Bharat, Mission 8 Billion, and Saturday for Society.",
      },
      {
        property: "og:title",
        content: "Civic Initiatives | UHO Law Club & United Human Organization",
      },
      {
        property: "og:description",
        content:
          "Green Bharat Great Bharat, Saturday for Society, and UHO initiatives beyond the courtroom.",
      },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://uholawclub.com/initiatives" },
    ],
    links: [{ rel: "canonical", href: "https://uholawclub.com/initiatives" }],
  }),
    ...
    <>
      <section className="mx-auto max-w-7xl px-6 pt-14 pb-16">
        ...
        <h1 className="mt-6 max-w-4xl font-serif text-[clamp(2.25rem,5vw,4.5rem)] leading-[1.05] text-paper">
          A chambers that closes on Saturdays —{" "}
          <em className="text-gold/90">because that's when the real work happens.</em>
        </h1>
          ...
          <div className="md:col-span-5">
            ...
            <figure className="mt-px bg-navy p-6">
              <img
                ...
                alt="Avinash Pathak in a United Human Organization shirt"
                width={1080}
                height={1080}
                loading="lazy"
                className="w-full bg-paper"
              />
              <figcaption className="mt-4 font-mono text-[10px] uppercase tracking-[0.22em] text-gold">
                Avinash Pathak · Founder, United Human Organization
              </figcaption>
            </figure>
          </div>
          <div className="md:col-span-7 flex flex-col justify-center">
            <p className="font-mono text-[11px] uppercase tracking-[0.3em] text-steel">
              Manifesto · Since 2012
            </p>
            <h2 className="mt-3 font-serif text-4xl md:text-5xl text-navy">
              The Great Aryan Dream.
            </h2>
            <p className="mt-6 max-w-xl text-base leading-relaxed text-navy/85">
              The founding text of UHO. Written when Avinash was fifteen. Its central argument —
              that a civilization ought to be measured by its trees, its water, and the smallest
              voice it protects — remains the chambers' unofficial constitution.
            </p>
